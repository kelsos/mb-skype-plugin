...
namespace MusicBeePlugin.SkypeControl
{
    internal class Platform
    {
        ...
        [DllImport("user32.dll")]
        public static extern IntPtr SendMessageTimeout(IntPtr windowHandler, uint msg, IntPtr wParam, IntPtr lParam,
                                                       SendMessageTimeoutFlags flags, uint timeout, out IntPtr result);

        [DllImport("user32.dll")]
        public static extern IntPtr SendMessageTimeout(IntPtr windowHandle, uint msg, IntPtr wParam,
